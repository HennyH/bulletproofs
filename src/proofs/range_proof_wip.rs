...
impl<E: Curve> StatementRP<E> {
    pub fn generate_bases(
        ...
        let label = BigInt::mod_sub(init_seed, &BigInt::one(), Scalar::<E>::group_order());
...
#[derive(Clone, Debug, Serialize, Deserialize)]
pub struct RangeProofWIP<E: Curve> {
    A: Point<E>,
    weighted_inner_product_proof: WeightedInnerProdArg<E>,
}

impl<E: Curve> RangeProofWIP<E> {
    pub fn prove(
        stmt: StatementRP<E>,
